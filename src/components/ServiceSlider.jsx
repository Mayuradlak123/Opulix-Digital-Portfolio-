    ...
    <>
      ...
      <div className="slider-container">
        <div className="carousel-container">
          <div className="content-container">
            ...
            <div className="carousel-controls py-2 ">
              <button onClick={prevSlide} >
                <svg className='' xmlns="http://www.w3.org/2000/svg" width="39" height="40" viewBox="0 0 39 40" fill="none">
              ...
              <button onClick={nextSlide} >
                <svg className='' xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
          ...
          <div className="slide-image-container w-full">
            {/* <Swiper
              ref={swiperRef}
              effect={"coverflow"}
              grabCursor={true}
